...
OBS2: este código vai criar uma pasta de saída chamada "sem-bordas-externas", vai cortar as margens externas de cada
página e salvar as imagens cortadas nessa pasta criada
