...
OBS2: o objetivo deste passo é pegar as colunas já recortadas e empilhar uma em cima da outra, na ordem correta, para formar uma única imagem final. 
Futuramente, essa imagem concatenada será dividida em imagens de cada questão, mas isso será feito no passo 7.

OBS3: este código vai criar uma imagem final chamada "colunas_concatenadas_verticalmente.png" que vai ter todas as colunas concatenadas verticalmente na ordem 
correta

OBS4: não compensa concatenar as páginas inteiras. Tenha isso em mente para o passo 7
